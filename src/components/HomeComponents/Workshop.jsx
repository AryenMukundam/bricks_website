...
const Workshop = () => {
  ...
  const days = [
    {
      ...
      color: "from-orange-500 to-red-600", // swapped from Day 2
      bgColor: "bg-gradient-to-br from-orange-50 to-red-50", // swapped
      accentColor: "bg-orange-500", // swapped
      sessions: [
    ...
    },
    {
      ...
      color: "from-blue-500 to-purple-600", // swapped from Day 1
      bgColor: "bg-gradient-to-br from-blue-50 to-purple-50", // swapped
      accentColor: "bg-blue-500", // swapped
      sessions: [
  ...
  return (
    <section className=" w-full py-16 px-4 bfrom-gray-50 to-blue-50 relative overflow-hidden">
      {/* Background Decorations */}
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-10 left-10 w-60 h-60 bg-orange-300 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 right-10 w-64 h-64 bg-purple-300 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4 relative">
            ...
            <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-32 h-1 bg-gradient-to-r from-orange-400 via-orange-500 to-red-500 rounded-full"></div>
          </h2>
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
          {/* Day Header */}
          <div className={`bg-gradient-to-r ${days[activeDay].color} text-white p-6 text-center`}>
          ...
          <div className="h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
            <div className="p-6 space-y-4">
              {days[activeDay].sessions.map((session, sessionIndex) => (
                <div
                  key={sessionIndex}
                  className={`${days[activeDay].bgColor} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-102 border border-white/50 relative overflow-hidden group`}
                >
                  {/* Background Pattern */}
                  <div className="absolute inset-0 opacity-5 group-hover:opacity-10 transition-opacity duration-300">
                    <div className="absolute -top-6 -right-6 w-20 h-20 bg-white rounded-full"></div>
                    <div className="absolute -bottom-6 -left-6 w-16 h-16 bg-gray-300 rounded-full"></div>
                  </div>
                  ...
                  <div className="relative z-10 flex items-start gap-4">
                    ...
                    <div className="flex-shrink-0">
                      ...
                      <div className={`inline-flex items-center px-3 py-1 rounded-full ${days[activeDay].accentColor} text-white text-xs font-bold shadow-md`}>
