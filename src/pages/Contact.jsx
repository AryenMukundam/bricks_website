  ...
  return (
    <div className="bg-gray-50 font-sans min-h-screen">
      <div className="max-w-6xl mx-auto p-5">
        ...
        {/* Contact Information */}
        <div className="bg-[#fff8f2]  p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 mb-10">
          <h2 className="text-2xl font-semibold text-orange-500 mb-6 flex items-center">
            <div className="w-1 h-8 bg-gradient-to-b from-orange-500 to-orange-400 rounded-full mr-4"></div>
            Contact Information
          </h2>

          {/* Phone */}
          <div className="flex items-center mb-4 p-3 bg-[#fff8f2]  rounded-lg hover: transition-colors">
            <svg
              className="w-6 h-6 text-orange-500 mr-4 flex-shrink-0"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
          ...
          {/* Website */}
          <div className="flex items-center p-3 bg-[#fff8f2]  rounded-lg hover: transition-colors">
            <svg
              className="w-6 h-6 text-orange-500 mr-4 flex-shrink-0"
              viewBox="0 0 24 24"
              fill="currentColor"
        ...
        <div className="bg-[#fff8f2]  p-12 rounded-3xl shadow-xl mb-12 border border-gray-100">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center justify-center">
            {/* WhatsApp Button */}
            <button
              className="inline-flex items-center gap-4 bg-green-500 hover:bg-green-600 text-white px-10 py-6 rounded-2xl font-bold text-xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-green-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-300 min-w-[300px] group"
              onClick={() =>
                window.open(
            ...
            {/* Enroll Button */}
            <button
              className="px-12 py-6 text-xl font-bold flex items-center justify-center bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-2xl border-none min-w-[300px] transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-orange-300 focus:outline-none focus:ring-4 focus:ring-orange-300 group"
              onClick={() =>
                window.open(
            ...
            >
              <Sparkles
                className="mr-4 w-8 h-8 group-hover:rotate-12 transition-transform"
                aria-hidden="true"
              />
              ENROLL NOW
              <ArrowRight
                className="ml-4 w-8 h-8 group-hover:translate-x-1 transition-transform"
                aria-hidden="true"
              />
            </button>
          </div>
